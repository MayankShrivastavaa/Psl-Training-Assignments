/*Write a program to create a rectangular array containing a 
 multiplication table from 1*1 up to 12*12. 
 ...
 the first column with no heading, then the numbers 1 to 12 for the remaining columns. 
...
public class RectangularMultiplicationTable {
	public static void main(String[] args) {
		...
		System.out.println();//coming to next line
